...
def recognize(dir):
    ...
    # load the 2 models
    ottakshara_model = load_model('E:/Myproject/Tensorflow/KannadaHandwriting-master/CNN/cnn_model_ottak.h5')
    char_model = load_model('E:/Myproject/Tensorflow/KannadaHandwriting-master/CNN/cnn_model.h5')
